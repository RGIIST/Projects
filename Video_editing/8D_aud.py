...
def aud_to_8D(file_n):
    ...
    wav1 = stereo_wav
    wavfile.write('/content/outFile.wav', sampling_rate, wav1.T)
    tfm = sox.Transformer()
    tfm.treble(gain_db=5, slope=0.3)
    tfm.bass(gain_db=5, slope=0.3)
    tfm.build('/content/outFile.wav', '/content/effectFile.wav')
